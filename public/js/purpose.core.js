!(function (e, t) {
                    ...
                    if (((p = [s ? m.firstChild : m.lastChild]), s && y)) {
                      ...
                      (y &&
                        (b = d =
                          (c =
                            (u =
                              (f = (h = t)[_] || (h[_] = {}))[h.uniqueID] ||
                              (f[h.uniqueID] = {}))[e] || [])[0] === E && c[1]),
                      !1 === b)
                    )
                      for (
                        ;
            ...
            (m = S(
              ...
              (u = function (e, t, n, s, u) {
                ...
                for (
                  ...
                  if (l && f) {
                    for (
                      p = 0, t || f.ownerDocument === d || (h(f), (n = !g));
                      (m = r[p++]);
                ...
                if (((v += y), a && y !== v)) {
                  ...
                  if (e) {
                    if (0 < v) for (; y--; ) b[y] || _[y] || (_[y] = I.call(s));
                    _ = Ee(_);
                  }
                  j.apply(s, _),
                    u &&
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            he.test(t.type) && t.click && D(t, "input") && ke(t, "click", Ce),
            !1
          );
        },
        trigger: function (e) {
          var t = this || e;
          return (
            he.test(t.type) && t.click && D(t, "input") && ke(t, "click"), !0
          );
        },
        _default: function (e) {
          var t = e.target;
    ...
    if (
      ...
      for (l = (a = w.map(me(r, "script"), Pe)).length; f < h; f++)
        (c = r),
          ...
          n.call(e[f], c, f);
      if (l)
        for (u = a[a.length - 1].ownerDocument, w.map(a, He), f = 0; f < l; f++)
          (c = a[f]),
            pe.test(c.type || "") &&
  ...
  w.extend(w.event, {
    trigger: function (t, n, r, o) {
      ...
      if (
        ...
        if (!o && !d.noBubble && !m(r)) {
          for (
            c = d.delegateType || y, Et.test(c + y) || (a = a.parentNode);
            a;
            a = a.parentNode
          )
            v.push(a), (l = a);
        ...
        for (s = 0; (a = v[s++]) && !t.isPropagationStopped(); )
          (p = a),
            ...
            (h = (X.get(a, "events") || {})[t.type] && X.get(a, "handle")) &&
              h.apply(a, n),
            (h = u && a[u]) &&
              h.apply &&
              Y(a) &&
    ...
    w.extend({
      ...
      ajax: function (t, n) {
        ...
        if (
          ...
          if (((T.readyState = 1), f && m.trigger("ajaxSend", [T, p]), u))
            return T;
          p.async &&
            0 < p.timeout &&
            ...
            c
              ? (p.ifModified &&
                ...
                204 === t || "HEAD" === p.type
                  ...
                  : 304 === t
                  ? (x = "notmodified")
                  : ((x = _.state), (h = _.data), (c = !(d = _.error))))
  ...
  (function (e, t) {
        ...
        return (
          ...
          (e._jQueryInterface = function (n) {
            return this.each(function () {
              ...
              if (
                (i || ((i = new e(this, o)), t(this).data(T, i)),
                "number" == typeof n)
              )
                i.to(n);
    ...
    function ce(e) {
      ...
      for (
        var t = le(10) ? document.body : null, n = e.offsetParent || null;
              ...
              return (
                s.forEach(function (a, l) {
                  ...
                  var c,
                    ...
                    h = Math.floor,
                    d =
                      ("left" === i && h(u.right) > h(f.left)) ||
                      ("right" === i && h(u.left) < h(f.right)) ||
                      ("top" === i && h(u.bottom) > h(f.top)) ||
                      ("bottom" === i && h(u.top) < h(f.bottom)),
                    p = h(u.left) < h(n.left),
                  ...
                  (d || y || _) &&
                    ...
                    (e.offsets.popper = ye(
                      {},
                      e.offsets.popper,
                      De(e.instance.popper, e.offsets.reference, e.placement)
                    )),
      ...
      Be = (function () {
        function e(t, n) {
          ...
          !(function (t, n) {
            ...
            Object.keys(ye({}, e.Defaults.modifiers, r.modifiers)).forEach(
              function (t) {
        ...
        return (
          ...
          (e._clearMenus = function (n) {
            if (!n || (3 !== n.which && ("keyup" !== n.type || 9 === n.which)))
              for (
                var i = [].slice.call(document.querySelectorAll(Ze)),
                  r = 0,
                  o = i.length;
                r < o;
                r++
        ...
        return (
          ...
          (e._jQueryInterface = function (n, i) {
            return this.each(function () {
              ...
              if (
                (o || ((o = new e(this, s)), t(this).data(ot, o)),
                "string" == typeof n)
              ) {
                if (void 0 === o[n])
                  throw new TypeError('No method named "' + n + '"');
            ...
            a.forEach(function (e) {
              (function (e, t) {
                ...
                if (-1 !== t.indexOf(n))
                  return (
                    -1 === yt.indexOf(n) ||
                    Boolean(e.nodeValue.match(bt) || e.nodeValue.match(_t))
                  );
                for (
          ...
          (e._jQueryInterface = function (n) {
            return this.each(function () {
              ...
              if (
                ...
                (i || ((i = new e(this, r)), t(this).data(xt, i)),
                "string" == typeof n)
              ) {
                if (void 0 === i[n])
                  throw new TypeError('No method named "' + n + '"');
          ...
          (o._jQueryInterface = function (e) {
            return this.each(function () {
              ...
              if (
                ...
                (n || ((n = new o(this, i)), t(this).data(Ft, n)),
                "string" == typeof e)
              ) {
                if (void 0 === n[e])
      ...
      cn = (function () {
        ...
        return (
          ...
          (n._getConfig = function (e) {
            if (
              "string" !=
              typeof (e = r({}, Zt, "object" == typeof e && e ? e : {})).target
            ) {
              var n = t(e.target).attr("id");
              n || ((n = s.getUID(Kt)), t(e.target).attr("id", n)),
                (e.target = "#" + n);
            }
          ...
          (n._activate = function (e) {
            ...
            i.hasClass("dropdown-item")
              ? (i.closest(".dropdown").find(".dropdown-toggle").addClass(nn),
                i.addClass(nn))
              : (i.addClass(nn),
                i
                  .parents(rn)
          ...
          (e._jQueryInterface = function (n) {
            return this.each(function () {
              var i = t(this),
                r = i.data(un);
              if (
                (r || ((r = new e(this)), i.data(un, r)), "string" == typeof n)
              ) {
                if (void 0 === r[n])
                  throw new TypeError('No method named "' + n + '"');
                r[n]();
        ...
        return (
          ...
          (e._jQueryInterface = function (n) {
            return this.each(function () {
              ...
              if (
                (r ||
                  ((r = new e(this, "object" == typeof n && n)), i.data(bn, r)),
                "string" == typeof n)
              ) {
                if (void 0 === r[n])
                  throw new TypeError('No method named "' + n + '"');
              ...
              if ("string" == typeof n) {
                ...
                return (
                  e.history.indexOf(n) > -1
                    ? (e[n].elements = i)
                    : ((e[n] = (0, o.default)(i, t)), e.history.push(n)),
                  e[n]
                );
              }
            };
                    ...
                    return (
                      this.elements.forEach(function (t) {
                        var n = e.options.test(t, e.options),
                          ...
                          r = i > -1,
                          o = !n && r;
                        n && !r && (e.current.push(t), e.emit("enter", t)),
                          o && (e.current.splice(i, 1), e.emit("exit", t));
                      }),
                      this
                    );
                  },
                ...
                if (
                  ...
                  (S = function () {
                    ...
                    if (
                      ...
                      w &&
                        ((b = w = !1),
                        null == s && (n.insertAfter(k), k.detach()),
                        n
            ...
            if (4 === r.readyState) {
              ...
              if (r.responseXML instanceof Document)
                ...
                if (!e || e.getElementsByTagName("parsererror").length)
                  return i("Unable to parse SVG file: " + t), !1;
            ...
            -1 === a.indexOf(t) &&
              ...
              h(u, function (i) {
                ...
                i.setAttribute(
                  ...
                  (function (e) {
                    for (
                      var t = {}, n = (e = e.split(" ")).length, i = [];
                      n--;

                    )
                      t.hasOwnProperty(e[n]) ||
                        ((t[e[n]] = 1), i.unshift(e[n]));
                    return i.join(" ");
                  })(h)
                );
                ...
                Object.keys(_).forEach(function (e) {
                  ...
                  for (
                    var t = 0,
                      n = (m = i.querySelectorAll("defs " + g + "[id]")).length;
                    n > t;
                    t++
                  ) {
                    var o;
                ...
                for (
                  ...
                  ((E = x[C].getAttribute("type")) &&
                    ...
                    ((w = x[C].innerText || x[C].textContent),
                    T.push(w),
                    i.removeChild(x[C]));
                if (
                  T.length > 0 &&
  ...
  (function (e, t) {
    ...
    function t(t) {
      ...
      return (
        ...
        {
          height: Math.ceil(
            i.data.outer.offset().top - i.data.inner.offset().top || 0
          ),
          width: Math.ceil(
            i.data.outer.offset().left - i.data.inner.offset().left || 0
          ),
        }
      );
    }
        ...
        i.scroll ||
          ...
          e(window).resize(function () {
            ...
            if (i.scroll && (i.scroll.height || i.scroll.width)) {
              var n = t();
              (n.height === i.scroll.height && n.width === i.scroll.width) ||
                ((i.scroll = n), (e = !0));
            }
            a(e);
          })),
    ...
    o.prototype = {
      ...
      init: function (t) {
        ...
        if (
          ...
          return (
            e.isFunction(l.onFallback) && l.onFallback.apply(this, [o]), !1
          );
        if (u)
          ((f = {
            height: "auto",
          ...
          if (
            ((this.wrapper = u =
              e("<div>")
                ...
                .css(
                  "position",
                  "absolute" === o.css("position") ? "absolute" : "relative"
                )
                .insertBefore(o)
                .append(o)),
            ...
            s.scroll
              ...
              .on("mousedown" + a, function (n) {
                ...
                var a = {
                    ...
                    scrollbarSize:
                      s.scroll.bar["x" === t ? "outerWidth" : "outerHeight"](),
                  },
                  c = 0,
                  m = 0;
                if (e(this).hasClass("scroll-arrow")) {
                  if (
                    ((f = e(this).hasClass("scroll-arrow_more") ? 1 : -1),
                    (d = l.scrollStep * f),
                ...
                return (
                  ...
                  setTimeout(function () {
                    r.scrollTo &&
                      (o.animate(r.scrollTo, l.duration), (r.scrollTo = null));
                  }, 1),
      ...
      _updateScroll: function (t, n) {
        ...
        (n.isVisible = u - f > 1),
          n.isVisible
            ? (n.scroll.addClass(s), a.scroll.addClass(s), o.addClass(s))
          ...
          "y" === t &&
            (r.is("textarea") || u < f
              ...
              : o.css({ "max-height": f + i.scroll.height + "px" })),
              ...
              o.debug &&
                (window.console &&
                  console.log(
                    {
                      scrollHeight:
                        r.prop("scrollHeight") + ":" + s.scrolly.size,
  ...
  (function (e) {
    ...
    var t,
        ...
        return (
          "wheel" === t.type
            ...
            : this.options.touch &&
              "touchmove" === t.type &&
              (l =
                t.originalEvent.changedTouches[0].clientY - this.startClientY),
          {
      ...
      u = function (e, t) {
        ...
        return (
          (h.top =
            0 === f && (e.keyCode === i || e.keyCode === s || e.keyCode === a)),
          h.top ||
            ...
            (!0 !== this.options.strict || this.options.strictFn(n)) &&
              ...
              i.prevent &&
                ...
                this.options.animation &&
                  setTimeout(f.CORE.animationHandler.bind(this, n, r), 0),
          ...
          return (
            ...
            r.top
              ? (i.trigger(e.Event("top" + f.NAMESPACE)),
                this.options.animation &&
                  setTimeout(f.CORE.animationHandler.bind(this, i, "top"), 0),
                !1)
              : r.bottom
              ? (i.trigger(e.Event("bottom" + f.NAMESPACE)),
                this.options.animation &&
                  setTimeout(
                    f.CORE.animationHandler.bind(this, i, "bottom"),
                    0
                  ),
                !1)
              : void 0
